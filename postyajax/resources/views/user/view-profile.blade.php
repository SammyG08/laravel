...
<div class="container bg-transparent w-50 mb-4 p-3">
    <div class="container w-50">
        <div class="w-75 d-flex align-items-center">
            <img src="{{$user->getImageUrl()}}" alt="profile image" class="rounded-circle me-4" style="width:75px; height:75px">
            <div>
    ...
    @endif
    <div class="container mt-4 w-50">
        <button class="btn btn-success btn-sm"><a href="{{route('edit.profile', $user)}}" class="text-decoration-none text-white">Edit Profile</a></button>
    </div>
@endauth
@endsection